...
// Local database (source) - using the same URL as the app
const localPrisma = new PrismaClient()

// Production database (target) - using the production DATABASE_URL
const productionPrisma = new PrismaClient({
  datasources: {
    db: {
      url: 'postgres://fea2646b084682099ce36883962fda370744d8caae643ee50e13618e56fe264f:sk_hOtByPsz68q2L4Vz4eHlX@db.prisma.io:5432/?sslmode=require'
    }
  }
})
